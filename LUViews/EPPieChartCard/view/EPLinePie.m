...
{
    return [[EPLinePie alloc] initWithCenter:center radius:radius startAngle:startAngle endAngle:endAngle color:color duration:duration piePatternType:piePatternType isAnimated:isAnimated];
}
